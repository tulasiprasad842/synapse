...
export class DeptquotasetlimitComponent implements OnInit {
    ...
    if (this.editData != null) {
      ...
      if (this.editData.creditType.creditCode == "POP") {
        ...
        this.deptQuotaSetlimitForm.patchValue({
          ...
          currentThresholdLimit: this.editData.deptcredit ? this.editData.deptcredit.thresoldLimit : [],
          AvailableThresholds: this.editData.deptcredit ? this.editData.deptcredit.availableCredit : ''
        });
        ...
        this.deptQuotaSetlimitForm.patchValue({
          accountType: this.editData.creditType.creditName,
          currentThresholdLimit: this.editData.deptcredit ? this.editData.deptcredit.thresoldLimit : [],
          availableBalance: this.editData.deptcredit ? this.editData.deptcredit.availableCredit : ''
        });
      }
  ...
  addCredits() {
    ...
    this.creditService.updateDeptCredit(ICreatedept).subscribe((response: IResponse) => {
