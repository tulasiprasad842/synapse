    ...
    if (this.editUserdata != null) {
      ...
      if (this.editUserdata.creditType.creditCode == "POP") {
        ...
        this.userQuotaSetlimitForm.patchValue({
          ...
          currentThresholdLimit: this.editUserdata.userCredit ? this.editUserdata.userCredit.thresoldLimit : 0,
        });
        ...
        this.userQuotaSetlimitForm.patchValue({
          accountType: this.editUserdata.creditType.creditName,
          availableBalance: this.editUserdata.userCredit ? this.editUserdata.userCredit.availableCredit : '',
          currentThresholdLimit: this.editUserdata.userCredit ? this.editUserdata.userCredit.thresoldLimit : []
        });
      }
    }
  }
